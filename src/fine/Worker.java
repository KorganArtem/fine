...
public class Worker {
    ...
    public Worker() throws UnsupportedEncodingException, IOException{
        ...
        System.out.println("sdd"+response.getStatusLine());
        if (entity != null) {
    ...
    public void getAllFine() throws UnsupportedEncodingException, IOException{
        HttpClient httpclient = HttpClients.createDefault();
        HttpPost httppost = new HttpPost("http://api.pub.emp.msk.ru:8081/json/v10.0/transport/offence/getall");
        // Request parameters and other properties.
        List<NameValuePair> params = new ArrayList<NameValuePair>(2);
        params.add(new BasicNameValuePair("token", token));
        params.add(new BasicNameValuePair("session_id", sid));
